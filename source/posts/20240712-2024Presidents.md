...
A(merican) > B(ritish) > others. D > Germany, E > Spain, C > Wales, P > Russia, C > Korea, E > Greece, É > Ireland, A > Haiti and more. Hungary(M), Austria(O), Finland(S), Albania(S) are exceptions.
