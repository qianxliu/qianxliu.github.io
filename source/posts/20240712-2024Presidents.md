...
A(merican)/A(ustralian) > B(ritish) > C(anadian) > others. D > Germany, E > Spain, C > Wales, P > Russia, C > Korea, E > Greece, A > Scotland, É > Ireland, A > Haiti and more. Hungary(M), Austria(Ö), Finland(S), Albania(S), Japan(N) are exceptions.
